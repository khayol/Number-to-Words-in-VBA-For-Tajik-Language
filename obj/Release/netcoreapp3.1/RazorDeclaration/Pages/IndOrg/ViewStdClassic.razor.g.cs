#pragma checksum "E:\NewProjects\01\Woorj\Pages\IndOrg\ViewStdClassic.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8f100fe860c4609b834b0c906f1d64c325bec768"
// <auto-generated/>
...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/IndOrg/ViewStdClassic")]
...
#nullable restore
#line 101 "E:\NewProjects\01\Woorj\Pages\IndOrg\ViewStdClassic.razor"
    ...
    {
        NavigationManager.NavigateTo("/IndOrg/Add");
    }
    ...
    protected void Edit(string p_selectedRow)
    {
        if ( int.Parse(p_selectedRow)<=0) //String.IsNullOrEmpty(p_selectedRow)
        {
            ...
            NavigationManager.NavigateTo("/IndOrg/Edit/" + p_selectedRow);
        }
    }
    protected void Delete(string p_selectedRow)
    {
        ...
        {
            NavigationManager.NavigateTo("/IndOrg/Delete/" + p_selectedRow);
        }
    ...
    void Cancel()
    {
        NavigationManager.NavigateTo("/IndOrg/View");
    }
